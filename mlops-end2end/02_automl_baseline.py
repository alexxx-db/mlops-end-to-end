...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F02_automl_baseline&cid=2556758628403379&uid=4876777410364310">
...
run_id=run['best_trial_run_id']
dst_path=eval_temp_dir
eval_path = mlflow.artifacts.download_artifacts(run_id, dst_path)
...
# MAGIC %sh ls /local_disk0/tmp/6bfbdf68
