...
# MAGIC - ML runtime [11.3+ ](https://docs.databricks.com/release-notes/runtime/11.3ml.html)
...
print(f"{CATALOG}.{QUICKSTART_MONITOR_DB}.{TABLE_NAME}")
...
dm_info = dm.create_or_update_monitor(
    table_name=f"{CATALOG}.{QUICKSTART_MONITOR_DB}.{TABLE_NAME}", # Or it could be f"{CATALOG}.{QUICKSTART_MONITOR_DB}.{TABLE_NAME}"
